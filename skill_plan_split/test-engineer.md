...
- `~/.codex/skills/test-engineer/agents/openai.yaml`
- `~/.codex/skills/test-engineer/references/mode-a.md`
- `~/.codex/skills/test-engineer/references/mode-b.md`
- `~/.codex/skills/test-engineer/references/trigger-boundaries.md`
...
1. 用 `init_skill.py` 仅创建 `test-engineer` 脚手架。
