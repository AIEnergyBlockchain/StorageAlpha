...
- `~/.codex/skills/algorithm-engineer/SKILL.md`
- `~/.codex/skills/algorithm-engineer/agents/openai.yaml`
- `~/.codex/skills/algorithm-engineer/references/mode-a.md`
- `~/.codex/skills/algorithm-engineer/references/mode-b.md`
- `~/.codex/skills/algorithm-engineer/references/trigger-boundaries.md`
...
1. 用 `init_skill.py` 仅创建 `algorithm-engineer` 脚手架。
